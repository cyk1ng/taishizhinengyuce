...
-- 一班 早班 (SHIFT_TYPE=2)
('R001', '001', '张伟', '一班', '2026-03-26', 2, 1, 3, 'DEPT001', '广州供电局'),
('R002', '002', '李明', '一班', '2026-03-26', 2, 1, 2, 'DEPT001', '广州供电局'),
('R003', '003', '王芳', '一班', '2026-03-26', 2, 1, 1, 'DEPT001', '广州供电局'),
-- 二班 中班 (SHIFT_TYPE=3)
('R004', '005', '陈红', '二班', '2026-03-26', 3, 1, 3, 'DEPT001', '广州供电局'),
('R005', '006', '赵刚', '二班', '2026-03-26', 3, 1, 2, 'DEPT001', '广州供电局'),
-- 三班 晚班 (SHIFT_TYPE=1)
('R006', '009', '吴敏', '三班', '2026-03-26', 1, 1, 3, 'DEPT001', '广州供电局'),
('R007', '010', '郑华', '三班', '2026-03-26', 1, 1, 2, 'DEPT001', '广州供电局');

-- 2026-03-27 排班（计划中）
INSERT INTO `work_schedule_recode` (`RECORD_ID`, `USER_ID`, `USER_NAME`, `GROUP_NAME`, `SCHEDULE_DATE`, `SHIFT_TYPE`, `STATUS`, `ID_LEADER`, `CITY_DEPT_ID`, `CITY_DEPT_NAME`) VALUES
-- 四班 早班
('R008', '013', '杨波', '四班', '2026-03-27', 2, 1, 3, 'DEPT001', '广州供电局'),
('R009', '014', '何静', '四班', '2026-03-27', 2, 1, 2, 'DEPT001', '广州供电局'),
-- 一班 中班
('R010', '001', '张伟', '一班', '2026-03-27', 3, 1, 3, 'DEPT001', '广州供电局'),
('R011', '002', '李明', '一班', '2026-03-27', 3, 1, 2, 'DEPT001', '广州供电局'),
-- 二班 晚班
('R012', '005', '陈红', '二班', '2026-03-27', 1, 1, 3, 'DEPT001', '广州供电局'),
('R013', '006', '赵刚', '二班', '2026-03-27', 1, 1, 2, 'DEPT001', '广州供电局');

-- 2026-03-28 排班（计划中）
INSERT INTO `work_schedule_recode` (`RECORD_ID`, `USER_ID`, `USER_NAME`, `GROUP_NAME`, `SCHEDULE_DATE`, `SHIFT_TYPE`, `STATUS`, `ID_LEADER`, `CITY_DEPT_ID`, `CITY_DEPT_NAME`) VALUES
-- 三班 早班
('R014', '009', '吴敏', '三班', '2026-03-28', 2, 1, 3, 'DEPT001', '广州供电局'),
('R015', '010', '郑华', '三班', '2026-03-28', 2, 1, 2, 'DEPT001', '广州供电局'),
-- 四班 中班
('R016', '013', '杨波', '四班', '2026-03-28', 3, 1, 3, 'DEPT001', '广州供电局'),
('R017', '014', '何静', '四班', '2026-03-28', 3, 1, 2, 'DEPT001', '广州供电局'),
-- 一班 晚班
('R018', '001', '张伟', '一班', '2026-03-28', 1, 1, 3, 'DEPT001', '广州供电局'),
('R019', '002', '李明', '一班', '2026-03-28', 1, 1, 2, 'DEPT001', '广州供电局');
